...
export async function buildExecutivePresentation(model, onProgress = () => {}) {
  ...
  cover.addText('Decisiones comerciales sustentadas en Industria, AMDA, operación interna y GeoInteligencia.', { x: .84, y: 4.48, w: 11.35, h: .52, fontFace: 'Aptos', fontSize: 15, color: 'DCE9FA', margin: 0 });
