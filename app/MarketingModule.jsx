...
@media(max-width:1050px){.marketing-filters{grid-template-columns:repeat(2,1fr)}.marketing-kpis{grid-template-columns:repeat(3,1fr)}.marketing-intel-grid{grid-template-columns:1fr}.competition-market-grid{grid-template-columns:repeat(2,1fr)}.competition-grid{grid-template-columns:1fr}}
