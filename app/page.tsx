...
// Mantener la mayoría de los respaldos BDC en una sola escritura atómica.
// El endpoint admite hasta 12 MB; sólo fragmentamos cargas realmente grandes.
const STORAGE_CHUNK_SIZE = 8_000_000;
  ...
  (window as any).storage = {
    async get(key: string, shared = true) {
      ...
      try {
        ...
        const values = await Promise.all(Array.from({ length: manifest.chunks }, async (_, index) => {
