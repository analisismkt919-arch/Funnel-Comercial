...
export async function POST(request: Request) {
  ...
  try {
    ...
    return Response.json({ error: `La información se guardó, pero no fue posible eliminar sus fragmentos anteriores: ${cleanupError?.message || cleanupError}` }, { status: 500 });
  }
