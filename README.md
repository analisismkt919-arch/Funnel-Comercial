...
1. Exporta los históricos disponibles desde la plataforma actual.
2. Ingresa a la versión de Vercel como administrador.
3. Importa la plantilla histórica del funnel.
4. Importa BDC y la actualización ZIP de Industria.
5. Revisa catálogos, metas y usuarios.
